    ...
    >
      <div className="relative mx-auto max-w-4xl">
        ...
        <img
          ...
          alt="Gurparneet Kaur"
          loading="lazy"
          className="absolute -top-16 right-2 w-20 rotate-6 drop-shadow-lg transition-transform duration-300 hover:rotate-2 sm:-top-24 sm:right-6 sm:w-28 md:w-32 lg:-top-80 lg:right-0 lg:h-[calc(100%+26rem)] lg:w-auto"
        />
